...
export class NgerPasswordModel implements PasswordModel {
    getUser(username: string, password: string, callback?: import("oauth2-server").Callback<false | "" | 0 | import("oauth2-server").User | null | undefined> | undefined): Promise<false | "" | 0 | import("oauth2-server").User | null | undefined> {
