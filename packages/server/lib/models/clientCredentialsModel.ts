...
export class NgerClientCredentialsModel implements ClientCredentialsModel {
    getUserFromClient(client: import("oauth2-server").Client, callback?: import("oauth2-server").Callback<false | "" | 0 | import("oauth2-server").User | null | undefined> | undefined): Promise<false | "" | 0 | import("oauth2-server").User | null | undefined> {
